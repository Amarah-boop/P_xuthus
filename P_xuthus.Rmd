...
I loaded the leaflet library and created an interactive map. I added tiles from a custom URL template and overlaid circle markers, which display the species information when clicked.
